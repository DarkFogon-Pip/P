...
async def _check_for_new_devices(
    ...
    """Fetch appliances from API and trigger discovery for new ones."""
    ...
    for appliance in appliances:
        ...
        if appliance_id not in existing_ids:
            ...
            async_dispatcher_send(
                hass, f"{NEW_APPLIANCE}_{entry.entry_id}", appliance
            )

    discovered_ids = {a.appliance.applianceId for a in appliances}
